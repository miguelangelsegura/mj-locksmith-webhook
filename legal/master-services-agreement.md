# DISPANGO MASTER SERVICES AGREEMENT

**Jam Works Inc.**, a corporation incorporated under the *Canada Business Corporations Act*, operating as **Dispango**, with its registered office at 350 Bay Street, Suite 1300B, Toronto, Ontario M5H 2S6 ("**Dispango**", "**we**", "**us**")

and

the business identified in the signature block below ("**Client**", "**you**")

each a "Party" and together the "Parties".

**Effective Date:** the date of Client's signature below.
...
1.1 "**Services**" means the Dispango AI telephone answering and lead-capture service, including the telephone number we assign to you, call answering, transcription, lead extraction, SMS notification, and the customer dashboard.

1.2 "**Client Data**" means information you provide or that is generated through your use of the Services, including your business details, call recordings, transcripts, and captured lead information.

1.3 "**Assigned Number**" means the telephone number Dispango provisions for your use with the Services.

## 2. The Services

2.1 **Provision.** We will provide the Services during the Term in accordance with this Agreement.

2.2 **Assigned Number.** We provision and maintain the Assigned Number on your behalf. The Assigned Number is licensed to you for use with the Services and remains registered to Dispango. On termination you may request porting of the Assigned Number to a carrier of your choosing, and we will act reasonably to facilitate it at your cost, provided your account is paid in full.

2.3 **Call forwarding.** You are responsible for forwarding your business line to the Assigned Number and for any charges your own carrier levies for doing so.

2.4 **Changes.** We may modify, improve, or replace features of the Services provided we do not materially reduce their core function during a paid month.

## 3. Fees and Payment

3.1 **Subscription fee.** The fee for the Services is **$199 CAD per month**, per business location, billed monthly in advance to the payment method you provide. All amounts are in **Canadian dollars** and exclusive of applicable taxes, which will be added where required by law.

3.2 **Automatic renewal.** The subscription renews automatically each month until cancelled in accordance with Section 8.

3.3 **Late payment.** Overdue amounts bear interest at **1.5% per month (19.56% per annum)**, calculated from the due date. We may suspend the Services on any failed payment that remains unresolved after seven (7) days' notice.

3.4 **No refunds.** Fees already paid are non-refundable except where required by applicable consumer-protection law.

3.5 **Price changes.** We may change the subscription fee on thirty (30) days' written notice. If you do not accept the change, you may terminate under Section 8.2 before it takes effect.

## 4. Call Recording, Consent and Privacy

4.1 **Recording.** You acknowledge and agree that calls to the Assigned Number are **recorded and transcribed** as an inherent and necessary part of the Services, and that our automated agent announces this at the start of each call.

4.2 **Your responsibility.** You are responsible for ensuring that your own use of the Services, including forwarding your business line to us and any use you make of recordings, transcripts, or captured lead data, complies with all laws applicable to you — including privacy, call-recording, anti-spam (CASL), and telemarketing and do-not-call rules.

4.3 **Personal information.** Each Party will handle personal information in accordance with the *Personal Information Protection and Electronic Documents Act* (Canada) and applicable provincial privacy legislation. We process Client Data to provide the Services, in accordance with our Privacy Policy at https://dispango.com/privacy.

4.4 **Ownership.** As between the Parties, **Client Data belongs to you.** We may use Client Data to provide, secure, support and improve the Services, and may use aggregated and de-identified data (which does not identify you, your callers, or your customers) for service improvement and analytics.

4.5 **Retention.** On termination we will retain Client Data for ninety (90) days to allow export, after which we may delete it. You may request earlier deletion in writing.

## 5. Client Obligations

5.1 You will provide accurate business information and keep it current, including the services you offer, your service area, your pricing information, and the mobile number for lead delivery.

5.2 You will not use the Services for any unlawful purpose, to harass any person, or in any manner that could damage or overburden the Services.

5.3 You are solely responsible for your dealings with anyone who contacts you through the Services, including quoting, attending jobs, workmanship, pricing honoured, and any dispute arising from them.

## 6. Service Levels and Disclaimers

6.1 **NOT AN EMERGENCY SERVICE.** The Services are **not** an emergency service and must not be represented or relied upon as one. The Services do not connect callers to 911 or to any emergency responder. You will not advertise the Assigned Number as an emergency line.

6.2 **AI limitations.** You acknowledge that the Services rely on automated speech recognition and artificial intelligence, and **will not be perfect**. The Services may mishear, misinterpret, misclassify, incompletely capture, or fail to capture information from a call, and may occasionally fail to answer a call. **We do not warrant that the Services will capture every call or lead, that captured information will be accurate or complete, or that the Services will generate any particular volume of business, revenue, or leads.**

6.3 **Dependencies.** The Services depend on third-party telecommunications carriers, cloud hosting, and AI providers. We are not responsible for failures, outages, degradation or delays caused by those third parties, by your own carrier or equipment, or by your call-forwarding configuration.

6.4 **No uptime guarantee.** We aim to provide the Services continuously but do not guarantee uninterrupted or error-free operation. We may suspend the Services temporarily for maintenance, security, or where required by law.
...
7.2 **Excluded losses.** To the maximum extent permitted by law, we will not be liable for any indirect, incidental, special, consequential, exemplary or punitive damages, nor for **lost profits, lost revenue, lost business, lost or missed leads or jobs, loss of goodwill, or loss or corruption of data**, even if advised of the possibility of such damages.

7.3 **Missed calls and leads.** Without limiting Sections 6.2 or 7.2, **we are not liable for any business you do not win, any call not answered or not captured, any lead not delivered, or any information captured inaccurately.**
...
8.1 **Term.** This Agreement begins on the Effective Date and continues on a month-to-month basis until terminated.

8.2 **Termination by you.** You may terminate on **thirty (30) days'** written notice to hello@dispango.com. The Services continue until the end of the notice period, and fees already paid are not refunded.
...
*Dispango is a service of Jam Works Inc. · 350 Bay Street, Suite 1300B, Toronto, Ontario M5H 2S6 · hello@dispango.com · https://dispango.com*
